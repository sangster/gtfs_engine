...
# stub: gtfs_engine 1.5.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      s.add_runtime_dependency('activerecord-import', ['~> 0.19'])
      s.add_runtime_dependency('gtfs_reader', ['~> 1.2'])
      s.add_runtime_dependency('jbuilder', ['~> 2.7'])
      s.add_runtime_dependency('jsend_wrapper-rails', ['~> 0.3'])
      s.add_runtime_dependency('rails', ['< 6.0', '>= 4.1'])
      s.add_runtime_dependency('responders', ['~> 2.4'])
      s.add_development_dependency('bundler', ['~> 1.15'])
      s.add_development_dependency('guard-rspec', ['~> 4.7'])
      s.add_development_dependency('juwelier', ['~> 2.3'])
      s.add_development_dependency('pry-rails', ['~> 0.3'])
      s.add_development_dependency('yard', ['~> 0.9'])
    else
      s.add_dependency('activerecord-import', ['~> 0.19'])
      s.add_dependency('bundler', ['~> 1.15'])
      s.add_dependency('gtfs_reader', ['~> 1.2'])
      s.add_dependency('guard-rspec', ['~> 4.7'])
      s.add_dependency('jbuilder', ['~> 2.7'])
      s.add_dependency('jsend_wrapper-rails', ['~> 0.3'])
