...
The units used for *shape_dist_traveled* in the shapes.txt file must match the units that are used for this field in the "stop_times.txt":stop_time file.
