...
consumers should treat it mindful of its non-authoritative status. If *feed_start_date* or *feed_end_date* extend beyond the active calendar dates defined in "calendar.txt":calendar and "calendar_dates.txt":calendar_date, the feed is making an explicit assertion that there is no service for dates within the *feed_start_date* or *feed_end_date* range but not included in the active calendar dates.
