...
module GtfsEngine
  class Calendar < ActiveRecord::Base
    ...
    has_many :calendar_dates, inverse_of: :calendar, primary_key: :service_id, foreign_key: :service_id
    has_many :trips,          inverse_of: :calendar, primary_key: :service_id, foreign_key: :service_id
