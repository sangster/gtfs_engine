...
gc. rake gtfs_engine:install:migrations
...
gc. rake gtfs_engine:update[name]
...
gc. rake gtfs_engine:update

Updates every DataSource configured with @GtfsEngine.sources@.

h3. Delete a DataSource

gc. rake gtfs_engine:sets:delete[name,etag]

Deletes the DataSet from the *name*d source with the given *etag*.

h3. Count the number of resources in a DataSet

gc. rake gtfs_engine:sets:count[name,etag]
